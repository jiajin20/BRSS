...
| 部署方式 | systemd / Docker / Nginx 反向代理 |
...
详细说明见 [BiliRSS_Docker_部署手册.md](BiliRSS_Docker_部署手册.md) 。
...
├── UPDATE.md                        # 更新日志
├── BiliRSS_Docker_部署手册.md        # Docker 部署教程
├── README.md                        # 本文件
└── LICENSE                          # MIT License
```
...
A: 需要系统安装 ffmpeg。Windows: [ffmpeg.org](https://ffmpeg.org) 下载并添加 PATH；Linux: `sudo apt install ffmpeg`。
...
A: 使用部署 EXE 的「1. 首次部署」一键完成，或参考 [BiliRSS_Docker_部署手册.md](BiliRSS_Docker_部署手册.md) 使用 Docker 部署。
